...
const PLAY_STORE_URL = 'https://play.google.com/store/apps/details?id=com.pigfi.app';
        ...
        <Pressable style={styles.sheet} onPress={() => {}}>
          ...
          <View style={styles.headerRow}>
            ...
            <View style={styles.headerTextBlock}>
              ...
              <View style={styles.networkBadge}>
                ...
                <Text style={styles.networkText}>Cofrinho em dólar · USDC</Text>
              </View>
            </View>
            {!isBusy && (
              ...
              <View style={styles.body}>
                <View style={styles.balanceRow}>
                  ...
                  <Text style={styles.balanceLabel}>
                    Disponível: <Text style={styles.balanceValue}>${usdcBalance} USDC</Text>
                  </Text>
                </View>
                ...
                <View style={styles.warningRow}>
                  <MaterialIcons name="card-giftcard" size={14} color={Colors.mutedForeground} />
                  <Text style={styles.warningText}>
                    O presente vale para <Text style={styles.warningBold}>quem ainda não tem o PigFi</Text>.
                    {' '}Quem receber tem <Text style={styles.warningBold}>7 dias</Text> para resgatar —
                    depois disso o valor volta para você. Valor entre ${GIFT_MIN_USD} e ${GIFT_MAX_USD}.
                  </Text>
                </View>
                ...
                {errorMsg ? (
                  <View style={styles.errorCard}>
                    ...
                    <View style={{ flex: 1, gap: 2 }}>
                      <Text style={styles.errorTitle}>Presente não criado</Text>
                ...
                >
                  <LinearGradient
                    ...
                    style={[styles.confirmBtn, !canSend && styles.btnDisabled]}
                  >
          ...
          {step === 'creating' && (
            <View style={styles.centerBody}>
              ...
              <Text style={styles.statusSub}>Criando o cofrinho de presente no PigFi</Text>
            </View>
          )}
          ...
          {step === 'signing' && (
            <View style={styles.centerBody}>
              <ActivityIndicator color={Accent.secondary} size="large" />
              <Text style={styles.statusTitle}>Embrulhando o presente...</Text>
          ...
          {step === 'success' && (
            <View style={styles.centerBody}>
              ...
              <Pressable onPress={handleShare} style={{ alignSelf: 'stretch' }}>
                <LinearGradient
                  colors={giftGradient}
                  start={{ x: 0, y: 0 }}
                  end={{ x: 1, y: 1 }}
                ...
                >
                  ...
                  <Text style={styles.confirmBtnText}>Compartilhar presente</Text>
                </LinearGradient>
              </Pressable>
